...
A full-stack web application built for managing student records, featuring a modern UI, Cloudinary photo uploads, and an activity logging system.
...
## 🏗️ Architecture Note for Interview
